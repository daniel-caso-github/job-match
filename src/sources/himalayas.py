...
class HimalayasSource(Source):
    ...
    def fetch(
        ...
        *,
        ...
        for _ in range(max_pages):
            ...
            except Exception as exc:  # noqa: BLE001 — log and stop this source gracefully
            ...
            for j in jobs:
                ...
                except Exception as exc:  # noqa: BLE001 — skip malformed entry
    ...
    def _get_json(self, params: dict[str, Any]) -> dict[str, Any]:
        ...
        # Retry on 429 and 5xx; raise to trigger tenacity
...
def _cli() -> None:
    ...
    parser = argparse.ArgumentParser(description="Smoke test the Himalayas source.")
    parser.add_argument("--limit", type=int, default=5)
    parser.add_argument("--keywords", type=str, default="python")
    args = parser.parse_args()

    src = HimalayasSource()
    for i, job in enumerate(src.fetch(keywords=args.keywords, limit=args.limit, max_pages=1)):
        if i >= args.limit:
            break
